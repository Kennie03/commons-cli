...
public class OptionValidator_ESTest extends OptionValidator_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      String string0 = OptionValidator.validate("5_CRRZcX7s");
      assertEquals("5_CRRZcX7s", string0);
  }
  ...
  public void test3()  throws Throwable  {
      try { 
        OptionValidator.validate("<mx_`Ap;TFYWAY1");
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test5()  throws Throwable  {
      try { 
        OptionValidator.validate("_aWn-DT~9d*");
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // The option '_aWn-DT~9d*' contains an illegal character : '~'.
         //
         verifyException("org.apache.commons.cli.OptionValidator", e);
      }
  }
